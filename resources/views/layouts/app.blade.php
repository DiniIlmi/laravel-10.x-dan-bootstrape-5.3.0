...
<head>
    ...
    <title>@yield('title', 'Aplikasi PLN Tanah Enam Ratus')</title>
...
<body>
    ...
    <nav class="navbar navbar-expand-lg navbar-dark bg-dark">
        <div class="container-fluid">
            <a class="navbar-brand" href="#">PLN Tanah Enam Ratus</a>
    ...
    <footer class="bg-dark text-white text-center py-3 mt-4">
        <p>&copy; {{ date('Y') }} PLN Tanah Enam Ratus. All Rights Reserved.</p>
    </footer>
